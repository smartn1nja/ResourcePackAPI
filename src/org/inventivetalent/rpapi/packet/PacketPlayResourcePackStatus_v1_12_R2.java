...
public class PacketPlayResourcePackStatus_v1_12_R2 implements IPacketPlayResourcePackStatus {
	...
	public class ChannelHandler extends ByteToMessageDecoder {
		...
		public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
			if (PacketPlayInResourcePackStatus.class.isAssignableFrom(msg.getClass())) {
				PacketPlayResourcePackStatus_v1_12_R2.this.onPacketReceive(msg, this.p);
			}
